...
class PlayerView: UIView, UIGestureRecognizerDelegate {
    ...
    private func makeSubViews() {
        ...
        // 播放器layer  resizeAspectFill 视频内容填满不拉伸
    ...
    func makeBackButton() {
        ...
        backBtn = UIButton(frame:(CGRect(x: buttonPaddingx(), y: 20, width: FIT_SCREEN_WIDTH(25), height: FIT_SCREEN_WIDTH(25))))
    ...
    private func makeShareButton() {
        ...
        shareBtn.right = navView.width - buttonPaddingx()
    ...
    private func makePlayButton() {
        ...
        startButton.frame = CGRect(x: buttonPaddingx(), y: 0, width: FIT_SCREEN_WIDTH(15), height: FIT_SCREEN_WIDTH(18))
    ...
    private func makeMaxButton() {
        ...
        maxButton.right = toolBarView.right - buttonPaddingx()
...
//        self.addGestureRecognizer(panGesture)
    ...
    /// 视频iphoneX
    func buttonPaddingx() -> CGFloat {
        let paddingx:CGFloat = isFullScreen && IsIphoneX ? FIT_SCREEN_WIDTH(30) : FIT_SCREEN_WIDTH(10)
        return paddingx
    }
